...
for tarih, tahmin in zip(gelecekteki_tarihler_sirali, gelecekteki_usd_tahmini):
    tahmin_verisi = {
        "date": tarih,
        "usd": tahmin[0]
    }
