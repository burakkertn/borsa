...
for tarih, tahmin in zip(gelecekteki_tarihler_sirali, gelecekteki_jpy_tahmini):
    tahmin_verisi = {
        "date": tarih,
        "jpy": tahmin[0]
    }
