...
for tarih, tahmin in zip(gelecekteki_tarihler_sirali, gelecekteki_gbp_tahmini):
    tahmin_verisi = {
        "date": tarih,
        "gbp": tahmin[0]
    }
